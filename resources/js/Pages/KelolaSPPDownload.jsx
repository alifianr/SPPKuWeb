...
export default function KelolaSPPDownload() {
    ...
    const siswaData = [
        ...
        { id: 1, nama: "Alifia Nurhasanah", nisn: "213456789", invoice: "1234567MNO89P", bulan: "SPP Februari", nominal: "Rp. 500.000", beasiswa: "Rp 100.000", pembayaran: "Rp 400.000", kode: "213456", kelas: "X", kategori: "Beasiswa", status: "Lunas" },
        { id: 2, nama: "Alifia Nurhasanah", nisn: "312456789", invoice: "1234567OPQ89R", bulan: "SPP Februari", nominal: "Rp. 500.000", beasiswa: "Rp 100.000", pembayaran: "Rp 400.000", kode: "312456", kelas: "X", kategori: "Beasiswa", status: "Lunas" },
        { id: 3, nama: "Jara Aurira Hanifah", nisn: "412356789", invoice: "1234567STU89V", bulan: "SPP Februari", nominal: "Rp. 500.000", beasiswa: "Rp 500.000", pembayaran: "Rp 500.000", kode: "412356", kelas: "X", kategori: "Reguler", status: "Belum Lunas" },
        { id: 4, nama: "Zahra Aurora Hanifah", nisn: "512346789", invoice: "1234567WXY89Z", bulan: "SPP Februari", nominal: "Rp. 500.000", beasiswa: "Rp 500.000", pembayaran: "Rp 500.000", kode: "512346", kelas: "X", kategori: "Reguler", status: "Belum Lunas" },
    ];
        ...
        <div className="bg-primary font-sans min-h-screen px-4 py-2 text-black">
            <div className="w-full mx-auto mt-6 rounded-lg mobile:px-2 lg:px-16">
                ...
                <div className="text-center mb-6 text-black">
                    <h2 className="font-bold mb-2 mobile:text-lg lg:text-2xl">Semua Data SPP Siswa</h2>
                    <p className="font-bold mobile:text-lg lg:text-2xl">Bulan Januari</p> {/* Pastikan data tidak null */}
                </div>
                {/* Data Table */}
                    ...
                    <table className="min-w-full bg-white rounded-lg overflow-hidden">
                        <thead className="rounded-full">
                            <tr className="bg-green-50 border border-gray">
                                ...
                                <th className="py-2 px-4 border border-gray text-black font-bold">Nominal Beasiswa</th>
                                ...
                                <th className="py-2 px-6 border border-gray text-black text-center items-center justify-center font-bold">Status</th>
                            </tr>
                            ...
                            {filteredSiswa.length > 0 ? (
                                filteredSiswa.map((siswa) => (
                                    <tr key={siswa.id} className="hover:bg-gray-100">
                                        ...
                                        <td className="py-2 px-4 border text-black text-center">{siswa.invoice}</td>
