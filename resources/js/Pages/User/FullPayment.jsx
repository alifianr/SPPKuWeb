            ...
            <div className="w-full mx-auto mt-6 rounded-lg mobile:px-2 lg:px-16">
                ...
                <div className="flex md:flex-row items-center mb-6">
                    ...
                    <div className="text-black mobile:text-left lg:text-left">
                        ...
                        <p className="mobile:text-xs lg:text-lg">
                            Jl. Antasura Jl. Dan Perumahan No.25, Peguyangan Kaja, Kec. Denpasar Utara, Kota Denpasar, Bali 80238
                        </p>
                ...
                <div className="text-center mb-6 text-black">
                    ...
                    <p className="text-xl font-bold">Mei dan Juni 2024</p>
                </div>
                ...
                <div className="mb-4">
                    ...
                    {/* Tambahkan overflow-x-auto agar tabel bisa di-scroll di layar kecil */}
                            ...
                            <tbody>
                                {payments.map((payment, index) => (
                                    <tr key={payment.id}>
                                        ...
                                        <td className={`py-2 px-4 border-b border-gray-200 text-center ${payment.status === "Lunas" ? "text-green-600" : "text-red-600"}`}>
                                            {payment.status}
                                        </td>
